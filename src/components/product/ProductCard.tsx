    ...
    <motion.div whileHover={{ y: -4 }} transition={{ duration: 0.25 }} className="group h-full">
      ...
      >
        <div className="relative aspect-square overflow-hidden">
          <ProductImagePlaceholder tone={product.tone} className="h-full w-full transition-transform duration-500 group-hover:scale-105" />
        ...
        <div className="flex flex-1 flex-col gap-1.5 p-3.5">
          ...
          <p className="text-xs text-primary-500">{product.capsules} cápsulas · {product.mg}mg</p>
